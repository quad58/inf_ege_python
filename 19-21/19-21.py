...
#     h = [f(a+1, b, m-1), f(a, b+1, m-1), f(a*2, b, m-1), f(a, b*2, m-1)]
#     return any(h) if (m-1)%2 == 0 else all(h)
# print(19, [s for s in range(1, 194) if f(17, s, 2)]) # any
# print(19, [s for s in range(1, 194) if (not f(17, s, 1)) and f(17, s, 3)])
# print(19, [s for s in range(1, 194) if (not f(17, s, 2)) and f(17, s, 4)])
...
def f(a, m):
    ...
    return any(h) if (m-1)%2 == 0 else all(h)
print(19, [s for s in range(31, 1000) if f(s, 2)]) # all
print(19, [s for s in range(31, 1000) if (not f(s, 1)) and f(s, 3)])
print(19, [s for s in range(31, 1000) if (not f(s, 2)) and f(s, 4)])